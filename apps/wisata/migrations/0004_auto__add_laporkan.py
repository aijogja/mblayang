...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Laporkan'
        db.create_table('wisata_laporkan', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('wisata', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wisata.Wisata'])),
            ('alasan', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('wisata', ['Laporkan'])


    def backwards(self, orm):
        # Deleting model 'Laporkan'
        db.delete_table('wisata_laporkan')
    ...
    models = {
        ...
        'wisata.laporkan': {
            'Meta': {'object_name': 'Laporkan'},
            'alasan': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'wisata': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['wisata.Wisata']"})
        },
        ...
        'wisata.wisata': {
            ...
            'tanggal': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'})
        }
    }
